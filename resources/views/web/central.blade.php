	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
		<div class="container">
		  ...
		  <div class="collapse navbar-collapse" id="navbarResponsive">
			...
			<li class="nav-item">
				<a class="nav-link js-scroll-trigger" href="#topa">Home</a>
			  </li>
			  <li class="nav-item">
      ...
      <section class="wt-section bg-light" id="about">
        ...
        <div class="row justify-content-md-center text-center pb-lg-4 mb-lg-5 mb-4">
              <div class="col-md-8 text-center w-md-50 mx-auto mb-0">
                ...
                <p class="lead text-muted">Kakamega Central Sub-County is a branch working under the umbrella of Kakamega County Pastors’ Association.</p>
              </div>
        </div>
          ...
          <div class="container">
              <div class="row justify-content-between align-items-center text-center text-md-left">
                  ...
                  <div class="col-md-4 text-lg-right mt-md-0 mt-3">
                      <a href="#Reach Us" class="btn btn-pill btn-outline-light">Join Now</a>
                  </div>
              </div>
          </div>
      </div>
      ...
      <div class="row justify-content-md-center text-center pb-lg-4 mb-lg-5 mb-4">
        ...
        <div class="col-md-4">
                  <div class="bg-white p-5 mb-4 text-center rounded-md overflow-hidden b-hover" data-aos="fade-up"  data-aos-easing="linear" data-aos-delay="300">
                          ...
                          <p class="text-muted">(a)There shall be election of K.C.S.P.A. officials and
                            departmental leaders after every 5 Years 
                            <br>
                            (b) The 7 Office bearers of the Wards shall elect the 7
                            officials of the Sub-county. 
                            (b) The Secretariat officials shall be;
                            <br>
                            Chairman ,Vice Chairman , Secretary , Vice Secretary, Treasurer,Organizing Secretary,Member.
                            <br>
                            (c)Any office bearer shall serve Not more than two terms
                            <br>
                            (d) All Elections to be done during A.G.M.</p> 
                  </div>
              </div>
            <div class="col-md-4">
                  <div class="bg-white p-5 mb-4 text-center rounded-md overflow-hidden b-hover" data-aos="fade-up"  data-aos-easing="linear" data-aos-delay="500">
                          <h6 class="my-2 text-primary">K.C.S.P.A. SECRETARIAT COMMITTEE</h6>
                          <p class="text-muted">
                            1. Bsp. Odinga Chairman 
                            <br>
                            2. Bsp. Julius Abung’ana Chairman CfaN
                            <br>
                            3. Ev. Josephat Shichenje Ass. Chairman
                            <br>
                            4. Apostle Wilfred Omumia Org. Secretary 
                            <br>
                            5. Bsp. Francis Otsialo 
                            <br>
                            6. Pst. Nathan Lanya Ass. Secretary
                            <br>
                            7. Rev.Charles Keya Treasurer
                          </p> 
                  </div>
              </div>
