<form method="POST" id="welfareform" action="welfareregistration">
	@csrf
  		<div class="form-group">
        <label style="text-decoration: underline; align-content: center;"><strong>WELFARE REGISTRATION FORM</strong></label>
